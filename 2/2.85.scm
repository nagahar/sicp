...
(define (install-complex-package)
  ...
  (put 'equ? '(complex complex)
       (lambda (z1 z2) (zero? (magnitude (sub-complex z1 z2)))))
  (put '=zero? '(complex)
...
(define real1 (make-real 0.3))
(define real2 (make-real 1.0))
(define comp1 (make-complex-from-real-imag 4 10))
(define comp2 (make-complex-from-real-imag 4 0))
