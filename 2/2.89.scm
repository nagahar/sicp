(define (install-polynomial-package)
  ...
  (define (adjoin-term term term-list)
    (let ((loop (+ (- (order term) (length term-list)) 1)))
      #?=loop
      (if (= loop 0)
	  term-list
	  (cons (coeff term)
  ...
  (define (first-term term-list)
    (make-term (- (length term-list) 1) (car term-list)));;;change
...
(define pol1 (make-polynomial 'x '(1 0)))
(define pol2 (make-polynomial 'x '(2 1)))
(=zero? pol1)
(=zero? pol2)
(add pol1 pol2)
(mul pol1 pol2)
