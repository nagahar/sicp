(define (install-sparse-term-package)
  ...
  (put 'div-terms '(sparse-polynomial sparse-polynomial)
       (lambda (L1 L2) (tag (div-terms L1 L2))))
  (put 'div-terms '(sparse-polynomial dense-polynomial)
       (lambda (L1 L2) (tag (div-terms L1 (dense->sparse L2)))))
...
(define (install-dense-term-package)
  ...
  (put 'div-terms '(dense-polynomial dense-polynomial)
       (lambda (L1 L2) (tag (div-terms L1 L2))))
  (put 'div-terms '(dense-polynomial sparse-polynomial)
       (lambda (L1 L2) (tag (div-terms L1 (sparse->dense L2)))))
...
(define pol3 (make-polynomial 'x (make-dense-term '(0))))
(define pol4 (make-polynomial 'x (make-sparse-term '((5 1) (0 -1)))))
(define pol5 (make-polynomial 'x (make-sparse-term '((2 1) (0 -1)))))
(define pol6 (make-polynomial 'x (make-dense-term '(1 0 -1))))
(=zero? pol1)
(=zero? pol2)
(=zero? pol3)
(add pol1 pol2)
